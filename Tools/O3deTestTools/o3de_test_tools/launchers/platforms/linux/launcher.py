...
from o3de_test_tools.launchers.exceptions import TeardownError, ProcessNotStartedError
...
class LinuxLauncher(Launcher):
    ...
    def _kill(self):
        ...
        if self._proc is not None:
            ...
            o3de_test_tools.environment.waiter.wait_for(
                ...
                exc=o3de_test_tools.launchers.exceptions.TeardownError(
    ...
    def check_returncode(self):
        ...
        if return_code != 0:
            ...
            raise o3de_test_tools.launchers.exceptions.CrashError()
        return None
