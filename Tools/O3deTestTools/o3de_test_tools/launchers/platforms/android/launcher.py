...
from o3de_test_tools import HOST_OS_PLATFORM
...
class AndroidLauncher(Launcher):
    ...
    def _enable_android_capabilities(self):
        ...
        o3de_test_tools.mobile.android.undo_tcp_port_changes(self._device_id)

        # Handle tunneling for Android connections:
        o3de_test_tools.mobile.android.reverse_tcp(self._device_id, '61453', '61453')  # Shader Compiler
        o3de_test_tools.mobile.android.reverse_tcp(self._device_id, '45643', '45643')  # Asset Processor
        o3de_test_tools.mobile.android.forward_tcp(self._device_id, '4600', '4600')  # Remote Console
    ...
    def _is_valid_android_environment(self):
        ...
        """
        if not o3de_test_tools.mobile.android.can_run_android():
        ...
        connected_devices = o3de_test_tools.mobile.android.get_devices()
        if not connected_devices:
            raise o3de_test_tools.launchers.exceptions.SetupError(
                ...
                'Please connect an Android device to the host machine and add its ID to the o3de_test_tools config file, '
    ...
    def launch(self):
        ...
        if os.path.isfile(autoexec_cfg):
            o3de_test_tools.mobile.android.push_files_to_device(
                source=autoexec_cfg,
