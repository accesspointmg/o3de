...
import o3de_test_tools.launchers.platforms.base as Launchers
import o3de_test_tools.o3de.editor_test_utils as editor_utils
from o3de_test_tools._internal.managers.workspace import AbstractWorkspaceManager
from o3de_test_tools._internal.exceptions import EditorToolsFrameworkException, TestResultException
from o3de_test_tools.launchers import launcher_helper
from o3de_test_tools.launchers.exceptions import WaitTimeoutError
from o3de_test_tools.launchers.platforms.linux.launcher import LinuxEditor, LinuxAtomToolsLauncher
from o3de_test_tools.launchers.platforms.win.launcher import WinEditor, WinAtomToolsLauncher
...
class MultiTestSuite(object):
    ...
    class MultiTestCollector(pytest.Class):
        ...
        def _make_single_run(inner_test_spec: AbstractTestBase) -> typing.Callable:
            ...
            def single_run(self,
                ...
                :param workspace: The O3deTestTools workspace object
                :param collected_test_data: The TestData object to store the test results
                :param launcher_platform: The O3deTestTools launcher
    ...
    def get_number_parallel_executables():
        ...
        See o3de_test_tools._internal.pytest_plugin.multi_testing.py for full list of CLI options.
    ...
    def _collected_test_data(self, request: _pytest.fixtures.FixtureRequest) -> MultiTestSuite.TestData:
        ...
        if test_data.asset_processor:  # was assigned an AP to manage
            ...
            editor_utils.kill_all_o3de_processes(include_asset_processor=True)
        else:  # do not interfere as a preexisting AssetProcessor may be owned by something else
            editor_utils.kill_all_o3de_processes(include_asset_processor=False)
    ...
    def _exec_single_test(self,
                          request: _pytest.fixtures.FixtureRequest,
                          workspace: AbstractWorkspaceManager,
                          executable: o3de_test_tools.launchers.platforms.base.Launcher,
                          run_id: int,
                          log_name: str,
    ...
    def _run_parallel_batched_tests(self,
        ...
        :workspace: The O3deTestTools Workspace object
