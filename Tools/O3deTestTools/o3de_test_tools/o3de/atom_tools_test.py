...
from o3de_test_tools.o3de.multi_test_framework import MultiTestSuite, SharedTest, SingleTest
...
class AtomToolsSingleTest(SingleTest):
    ...
    def setup(instance: AtomToolsTestSuite.MultiTestCollector,
        ...
        :param workspace: O3deTestTools workspace manager
        """
        pass
...
class AtomToolsTestSuite(MultiTestSuite):
    ...
    def pytest_multitest_makeitem(
        ...
        """
        Enables o3de_test_tools._internal.pytest_plugin.multi_testing.pytest_pycollect_makeitem to collect the tests
        ...
        collected for that suite when using the o3de_test_tools.o3de.multi_test_framework module.
