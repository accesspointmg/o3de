...
OS and devices are detected and set as constants when o3de_test_tools.__init__() completes.
"""
import logging
import sys
import platform
...
if WINDOWS:
    ...
    from o3de_test_tools.launchers import (
        AndroidLauncher, WinLauncher, DedicatedWinLauncher, WinEditor, WinAtomToolsLauncher)
    ANDROID = o3de_test_tools.mobile.android.can_run_android()
    ...
    HOST_OS_EDITOR = NotImplementedError('O3deTestTools does not yet support Mac editor')
    HOST_OS_DEDICATED_SERVER = NotImplementedError('O3deTestTools does not yet support Mac dedicated server')
    HOST_OS_ATOM_TOOLS = NotImplementedError('O3deTestTools does not yet support Mac Atom Tools executables')
    from o3de_test_tools.launchers import MacLauncher
    ...
    ARM64 = False
    logger.warning(f'WARNING: O3deTestTools only supports Windows, Mac, and Linux. '
