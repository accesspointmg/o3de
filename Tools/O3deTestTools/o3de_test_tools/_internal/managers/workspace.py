...
import o3de_test_tools.o3de.settings as settings
import o3de_test_tools.o3de.shader_compiler
import o3de_test_tools._internal.managers.artifact_manager as artifact_manager
import o3de_test_tools._internal.managers.abstract_resource_locator as arl
...
class AbstractWorkspaceManager:
    ...
    def __init__(self,  # type: AbstractWorkspaceManager
        ...
        self.asset_processor = o3de_test_tools.o3de.asset_processor.AssetProcessor(self)
        self.shader_compiler = o3de_test_tools.o3de.shader_compiler.ShaderCompiler(self)
        ...
        self.settings = settings.O3deSettings(self.tmp_path, self.paths)
    ...
    def setup(self):
        ...
        if self.tmp_path:
            ...
            if os.path.exists(self.tmp_path):
                ...
                o3de_test_tools.environment.file_system.delete([self.tmp_path], True, True)
    ...
    def clear_cache(self):
        ...
        if os.path.exists(self.paths.cache()):
            ...
            o3de_test_tools.environment.file_system.delete([self.paths.cache()], True, True)
            return
    ...
    def clear_bin(self):
        ...
        if os.path.exists(self.paths.build_directory()):
            ...
            o3de_test_tools.environment.file_system.delete([self.paths.build_directory()], True, True)
            return
    ...
    def _execute_and_save_log(self, command, log_file_name):
        ...
        """
        temp_file_dir = os.path.join(tempfile.gettempdir(), "O3deTestTools")
