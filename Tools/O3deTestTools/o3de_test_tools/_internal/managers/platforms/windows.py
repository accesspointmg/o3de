...
import o3de_test_tools.environment.reg_cleaner
import o3de_test_tools.environment.waiter
import o3de_test_tools.launchers.exceptions

from o3de_test_tools._internal.managers.abstract_resource_locator import AbstractResourceLocator
...
class _WindowsResourceLocator(AbstractResourceLocator):
    """
    Override for locating resources in a Windows operating system running O3deTestTools.
    """
...
class WindowsWorkspaceManager(AbstractWorkspaceManager):
    ...
    def set_registry_keys(self):
        ...
        if sys.platform == 'win32':
            o3de_test_tools.environment.reg_cleaner.create_o3de_keys()

    def clear_settings(self):
        logger.debug("Build::setup_clear_registry")
        if sys.platform == "win32":
            o3de_test_tools.environment.reg_cleaner.clean_o3de_keys(exception_list=r"SOFTWARE\O3DE\O3DE\Identity")
