...
# Import any desired LTT modules from the package `o3de_test_tools`. All LTT modules can be viewed at `Tools/O3deTestTools/o3de_test_tools`.
...
# Note: For device testing, device ids must exist in ~/o3de_test_tools/devices.ini, see README.txt for more info.
...
class TestAutomatedTestingProject(object):
    ...
    def test_StartGameLauncher_Sanity(self, project):
        ...
        process_utils.kill_processes_named(names=process_utils.O3DE_PROCESS_KILL_LIST, ignore_extensions=True)
