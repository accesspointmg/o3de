...
Unit tests for o3de_test_tools.o3de.asset_processor
"""
import datetime
...
import o3de_test_tools.o3de.asset_processor
...
@mock.patch('o3de_test_tools._internal.managers.abstract_resource_locator.os.path.abspath',
...
@mock.patch('o3de_test_tools.o3de.asset_processor.logger.warning', mock.MagicMock())
class TestAssetProcessor(object):
    ...
    def test_Init_DefaultParams_MembersSetCorrectly(self, mock_workspace):
        under_test = o3de_test_tools.o3de.asset_processor.AssetProcessor(mock_workspace)
    ...
    @mock.patch('o3de_test_tools.o3de.asset_processor.AssetProcessor.connect_socket')
    @mock.patch('o3de_test_tools.o3de.asset_processor.ASSET_PROCESSOR_PLATFORM_MAP', {'foo': 'bar'})
    ...
    @mock.patch('o3de_test_tools.environment.process_utils.kill_processes_with_name_not_started_from',
                mock.MagicMock(return_value=None))
    @mock.patch('o3de_test_tools.environment.process_utils.process_exists', mock.MagicMock(return_value=True))
    ...
    def test_Start_ProcAlreadyRunning_ProcNotChanged(self, mock_connect, mock_popen, mock_workspace):
        ...
        under_test.asset_processor_platform = mock.MagicMock(return_value=o3de_test_tools.HOST_OS_PLATFORM)
    ...
    @mock.patch('o3de_test_tools._internal.managers.workspace.AbstractWorkspaceManager')
    @mock.patch('o3de_test_tools.o3de.asset_processor.waiter.wait_for')
    ...
    def test_Stop_ReturnsStopReason(self, mock_waiter, mock_workspace, test_id, _ap_proc, _control_connection,
        ...
        AssetProcessorError = o3de_test_tools.o3de.asset_processor.AssetProcessorError
        StopProcess = o3de_test_tools.o3de.asset_processor.StopReason
        o3de_test_tools.environment.waiter.wait_for = mock.MagicMock(side_effect=AssetProcessorError)
        under_test = o3de_test_tools.o3de.asset_processor.AssetProcessor(mock_workspace)
        if _ap_proc:
            under_test.get_process_list = mock.MagicMock(return_value=[mock.MagicMock()])
        else:
    ...
    def test_BackupAPSettings_Called_CallsBackupAPSettings(self, mock_workspace):
        ...
        mock_asset_processor = o3de_test_tools.o3de.asset_processor.AssetProcessor(mock_workspace)
    ...
    @mock.patch('o3de_test_tools.o3de.asset_processor.AssetProcessor.restore_ap_settings')
    @mock.patch('o3de_test_tools.o3de.asset_processor.AssetProcessor.stop')
    @mock.patch('o3de_test_tools._internal.managers.workspace.AbstractWorkspaceManager')
