...
Unit Tests for o3de_test_tools._internal.managers.abstract_resource_locator
"""
import os
...
import o3de_test_tools._internal.managers.abstract_resource_locator as abstract_resource_locator
...
class TestFindEngineRoot(object):
    ...
    @mock.patch('o3de_test_tools._internal.managers.abstract_resource_locator.os.path.abspath', mock.MagicMock())
    @mock.patch('o3de_test_tools._internal.managers.abstract_resource_locator.os.path.exists')
...
class TestFindProjectJson(object):
    ...
    @mock.patch('json.loads', mock.MagicMock())
    @mock.patch('o3de_test_tools.environment.file_system.find_ancestor_file')
...
class TestAbstractResourceLocator(object):
    ...
    @mock.patch('o3de_test_tools._internal.managers.abstract_resource_locator.os.path.expanduser')
    def test_DevicesFile_IsCalled_ReturnsDevicesFilePath(self, mock_expanduser):
        ...
        expected_path = os.path.join(mock_expanded_path, 'o3de_test_tools', 'devices.ini')
