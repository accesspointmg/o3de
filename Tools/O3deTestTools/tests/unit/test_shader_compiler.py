...
Unit tests for o3de_test_tools.o3de.shader_compiler
"""
...
class TestShaderCompiler(object):
    ...
    def test_Init_MockWorkspace_MembersSetCorrectly(self, mock_workspace):
        under_test = o3de_test_tools.o3de.shader_compiler.ShaderCompiler(mock_workspace)
    ...
    @mock.patch('o3de_test_tools.WINDOWS', True)
    ...
    @mock.patch('o3de_test_tools._internal.managers.workspace.AbstractWorkspaceManager')
    @mock.patch('subprocess.Popen')
    @mock.patch('o3de_test_tools.o3de.shader_compiler.MAC', True)
    ...
    @mock.patch('o3de_test_tools._internal.managers.workspace.AbstractWorkspaceManager')
    @mock.patch('subprocess.Popen')
    @mock.patch('o3de_test_tools.o3de.shader_compiler.logger.info')
    @mock.patch('o3de_test_tools.o3de.shader_compiler.MAC', True)
    ...
    @mock.patch('o3de_test_tools._internal.managers.workspace.AbstractWorkspaceManager')
    @mock.patch('o3de_test_tools.o3de.shader_compiler.process_utils.kill_processes_started_from')
    @mock.patch('o3de_test_tools.o3de.shader_compiler.waiter.wait_for')
