...
class TestWorkspaceManager:
    ...
    def test_Init_NoInheritanceAbstractWorkspaceManager_RaisesTypeError(self):
        ...
        with pytest.raises(TypeError):
            o3de_test_tools._internal.managers.workspace.AbstractWorkspaceManager(resource_locator=mock_resource_locator)

    @mock.patch('o3de_test_tools._internal.managers.artifact_manager.NullArtifactManager.__init__')
...
class TestTeardown(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.environment.file_system.delete', mock.MagicMock())
    @mock.patch('os.chdir')
