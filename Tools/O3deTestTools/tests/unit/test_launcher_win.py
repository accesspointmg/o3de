...
class TestWinLauncher(object):
    ...
    def test_BinaryPath_DummyPath_AddPathToExe(self):
        ...
        launcher = o3de_test_tools.launchers.WinLauncher(mock_workspace, ["some_args"])
    ...
    @mock.patch('o3de_test_tools.launchers.WinLauncher.binary_path', mock.MagicMock)
    @mock.patch('subprocess.Popen')
    def test_Launch_DummyArgs_ArgsPassedToPopen(self, mock_subprocess):
        dummy_args = ["some_args"]
        launcher = o3de_test_tools.launchers.WinLauncher(mock.MagicMock(), dummy_args)
    ...
    @mock.patch('o3de_test_tools.launchers.WinLauncher.is_alive')
    def test_Kill_MockAliveFalse_SilentSuccess(self, mock_alive):
        mock_alive.return_value = False
        mock_proc = mock.MagicMock()
        launcher = o3de_test_tools.launchers.WinLauncher(mock.MagicMock(), ["dummy"])
    ...
    def test_GetPid_HasProcess_ReturnsPid(self):
        mock_pid = 11111
        mock_launcher = o3de_test_tools.launchers.WinLauncher(mock.MagicMock(), ["dummy"])
        mock_proc = mock.MagicMock()
    ...
    @mock.patch('o3de_test_tools.launchers.WinLauncher.get_returncode')
    ...
    def test_CheckReturnCode_ReturnCodeIsNonZero_RaisesError(self, mock_get_returncode):
        ...
        with pytest.raises(o3de_test_tools.launchers.exceptions.CrashError):
            mock_launcher.check_returncode()
...
class TestWinEditor(object):
    ...
    def test_BinaryPath_DummyPath_AddPathToExe(self):
        ...
        mock_workspace = mock.MagicMock()
        mock_workspace.paths.build_directory.return_value = dummy_path
        launcher = o3de_test_tools.launchers.WinEditor(mock_workspace, ["some_args"])
...
class TestDedicatedWinLauncher(object):
    ...
    def test_BinaryPath_DummyPath_AddPathToExe(self):
        ...
        mock_workspace.paths.build_directory.return_value = dummy_path
        mock_workspace.project = dummy_project
        launcher = o3de_test_tools.launchers.DedicatedWinLauncher(mock_workspace, ["some_args"])
...
class TestWinAtomToolsLauncher(object):
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.win.launcher.os.path.isfile')
    def test_BinaryPath_DummyPathExeExists_AddPathToExe(self, mock_os_path_isfile):
        ...
        mock_workspace = mock.MagicMock()
        mock_workspace.paths.build_directory.return_value = dummy_path
        launcher = o3de_test_tools.launchers.WinAtomToolsLauncher(mock_workspace, dummy_app_file_name, ["some_args"])
    ...
    def test_BinaryPath_DummyPathExeDoesNotExist_RaiseSetupError(self, mock_os_path_isfile):
        ...
        under_test = o3de_test_tools.launchers.WinAtomToolsLauncher(mock_workspace, dummy_app_file_name, ["some_args"])
