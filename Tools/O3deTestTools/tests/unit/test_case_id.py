...
Unit tests for o3de_test_tools._internal.pytest_plugin.case_id
"""
...
import o3de_test_tools._internal.pytest_plugin.case_id as case_id
...
class TestCaseId(object):
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.case_id.log')
