...
Unit tests for o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command
"""
...
import o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command as failed_test_rerun_command
...
class TestRerunCommand(object):
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.sys.executable', MOCK_FOO_EXE)
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.sys.executable', MOCK_FOO_EXE)
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.WINDOWS', True)
    @mock.patch('sys.argv', mock.MagicMock())
    @mock.patch('os.path.exists', mock.MagicMock(return_value=True))
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.sys.executable', MOCK_FOO_EXE)
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.WINDOWS', False)
    @mock.patch('sys.argv', mock.MagicMock())
    @mock.patch('os.path.exists', mock.MagicMock(return_value=True))
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.os.path.abspath')
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.os.path.dirname')
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command._get_test_launcher_cmd')
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.os.path.abspath')
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.os.path.dirname')
    @mock.patch('os.path.exists', mock.MagicMock(return_value=False))
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.os.environ', {})
