...
import o3de_test_tools.launchers.exceptions
import o3de_test_tools.o3de.multi_test_framework as multi_test_framework
from o3de_test_tools.o3de.editor_test_utils import prepare_asset_processor
from o3de_test_tools.launchers.platforms.linux.launcher import LinuxAtomToolsLauncher, LinuxEditor
from o3de_test_tools.launchers.platforms.win.launcher import WinAtomToolsLauncher, WinEditor
...
class TestMultiTestSuite(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.kill_all_o3de_processes')
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite.filter_session_shared_tests')
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite.filter_session_shared_tests')
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite.get_shared_tests')
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.skip_pytest_runtest_setup', mock.MagicMock())
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.skip_pytest_runtest_setup')
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.skip_pytest_runtest_setup', mock.MagicMock(side_effect=Exception))
...
class TestUtils(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.o3de.asset_processor.AssetProcessor.start')
    ...
    def test_PrepareAssetProcessor_NoAP_KillAndCreateAP(self, mock_kill_processes, mock_proc_exists, mock_start):
        ...
        assert isinstance(mock_collected_test_data.asset_processor, o3de_test_tools.o3de.asset_processor.AssetProcessor)
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.get_module_filename')
    ...
    def test_ReportResult_TestPassed_ReportsCorrectly(self, mock_print):
        ...
        mock_output = 'mock_output'
        mock_log_output = 'mock_log_output'
        mock_pass = o3de_test_tools.o3de.multi_test_framework.Result.Pass(mock_test_spec, mock_output, mock_log_output)
        o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._report_result(mock_test_name, mock_pass)
    ...
    def test_ReportResult_TestFailed_FailsCorrectly(self, mock_pytest_fail):
        ...
        mock_output = 'mock_output'
        mock_log_output = 'mock_log_output'
        mock_fail = o3de_test_tools.o3de.multi_test_framework.Result.Fail(mock_test_spec, mock_output, mock_log_output)

        o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._report_result(mock_test_name, mock_fail)
...
class TestRunningTests(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._get_results_using_output')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.retrieve_editor_log_content')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.retrieve_log_path')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.get_testcase_module_filepath')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.cycle_crash_report')
    ...
    def test_ExecSingleTest_TestSucceeds_ReturnsPass(self, mock_cycle_crash, mock_get_testcase_filepath,
        ...
        mock_test_suite = o3de_test_tools.o3de.multi_test_framework.MultiTestSuite()
        mock_workspace = mock.MagicMock()
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.retrieve_crash_output')
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._get_results_using_output')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.retrieve_editor_log_content')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.retrieve_log_path')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.get_testcase_module_filepath')
    ...
    def test_ExecSingleTest_TestTimeout_ReturnsTimeout(self, mock_cycle_crash, mock_get_testcase_filepath,
        ...
        mock_test_spec = mock.MagicMock()
        mock_test_spec.__name__ = 'mock_test_name'
        mock_executable.wait.side_effect = o3de_test_tools.launchers.exceptions.WaitTimeoutError()
        mock_get_output_results.return_value = {}
    ...
    def test_ExecMultitest_OneCrash_ReportsOnUnknownResult(self, mock_cycle_crash, mock_get_testcase_filepath,
        ...
        mock_test_spec_2.__name__ = 'mock_test_name_2'
        mock_test_spec_list = [mock_test_spec, mock_test_spec_2]
        mock_unknown_result = o3de_test_tools.o3de.multi_test_framework.Result.Unknown(test_spec=None)
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._report_result')
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._exec_single_test')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.save_failed_asset_joblogs', mock.MagicMock())
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._test_reporting')
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._exec_multitest')
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.MultiTestSuite._get_number_parallel_executables')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.save_failed_asset_joblogs', mock.MagicMock())
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.kill_all_o3de_processes')
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.prepare_asset_processor')
    @mock.patch('o3de_test_tools.launchers.launcher_helper.create_editor')
    @mock.patch('o3de_test_tools.launchers.launcher_helper.create_atom_tools_launcher')
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test_utils.save_failed_asset_joblogs')
...
class TestMultiTestCollector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_test_class = o3de_test_tools.o3de.multi_test_framework.MultiTestSuite.MultiTestCollector.from_parent(
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.isinstance', mock.MagicMock())
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.issubclass', mock.MagicMock())
    ...
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.isinstance', mock.MagicMock(return_value=False))
    @mock.patch('o3de_test_tools.o3de.multi_test_framework.issubclass', mock.MagicMock(return_value=False))
