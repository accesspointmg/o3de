...
Unit tests for o3de_test_tools.log.log_monitor
"""
...
mock_launcher = mock.MagicMock(o3de_test_tools.launchers.platforms.base.Launcher)


def mock_log_monitor():
    """Returns a LogMonitor() object with all required parameters & resets attributes for each test."""
    log_monitor = o3de_test_tools.log.log_monitor.LogMonitor(
...
class TestLogMonitor(object):
    ...
    def test_Init_HasRequiredParams_ReturnsLogMonitorObject(self):
        assert o3de_test_tools.log.log_monitor.LogMonitor(
    ...
    def test_CheckExactMatch_HasMatch_ReturnsString(self):
        ...
        under_test = o3de_test_tools.log.log_monitor.check_exact_match(line, expected_line)
    ...
    def test_CheckExactMatch_HasExactMatchWithEscapeCharacter_ReturnsString(self):
        ...
        under_test = o3de_test_tools.log.log_monitor.check_exact_match(line, line)
    ...
    def test_Monitor_UTF8StringsPresentAndExpected_Success(self):
        ...
        with mock.patch('o3de_test_tools.log.log_monitor.open', return_value=mock_file, create=True):
    ...
    def test_Monitor_AllLinesNotFound_RaisesLogMonitorException(self):
        ...
        with mock.patch('o3de_test_tools.log.log_monitor.open', return_value=mock_file, create=True):
            with pytest.raises(o3de_test_tools.log.log_monitor.LogMonitorException):
    ...
    @mock.patch('o3de_test_tools.environment.waiter.wait_for', mock.MagicMock)
    ...
    def test_Monitor_InvalidLauncherType_RaiseLogMonitorException(self):
        invalid_log_monitor = o3de_test_tools.log.log_monitor.LogMonitor(
    ...
    @mock.patch('o3de_test_tools.log.log_monitor.logging.Logger.warning')
    @mock.patch('os.path.exists', mock.MagicMock(return_value=True))
