...
class TestUnZip(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.environment.file_system.check_free_space')
    ...
    @mock.patch('o3de_test_tools.environment.file_system.logger')
    @mock.patch('os.path.exists')
    @mock.patch('o3de_test_tools.environment.file_system.check_free_space')
    @mock.patch('os.path.join')
    ...
    @mock.patch('o3de_test_tools.environment.file_system.logger')
    @mock.patch('os.path.exists')
    @mock.patch('o3de_test_tools.environment.file_system.check_free_space', mock.MagicMock())
...
class TestDelete(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.environment.file_system.change_permissions', mock.MagicMock())
    ...
    @mock.patch('o3de_test_tools.environment.file_system.change_permissions')
...
class TestRename(unittest.TestCase):
    ...
    def test_Rename_SourceDoesNotExist_ErrorReported(self, mock_rename):
        with self.assertLogs('o3de_test_tools.environment.file_system', 'ERROR') as captured_logs:
...
class TestDeleteOldest(unittest.TestCase):
    ...
    @mock.patch('glob.iglob')
    @mock.patch('os.path.getctime')
    @mock.patch('o3de_test_tools.environment.file_system.delete')
...
class TestFileBackup(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.environment.file_system.logger.warning')
    @mock.patch('shutil.copy2')
    @mock.patch('os.path.exists')
    @mock.patch('os.path.isdir')
    ...
    @mock.patch('o3de_test_tools.environment.file_system.logger.error')
    @mock.patch('os.path.exists')
    @mock.patch('os.path.isdir')
