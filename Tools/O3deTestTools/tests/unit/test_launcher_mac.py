...
class TestMacLauncher(object):
    ...
    def test_Construct_TestDoubles_MacLauncherCreated(self):
        under_test = o3de_test_tools.launchers.MacLauncher(mock.MagicMock(), ["some_args"])
        assert isinstance(under_test, o3de_test_tools.launchers.Launcher)
        assert isinstance(under_test, o3de_test_tools.launchers.MacLauncher)
    ...
    def test_BinaryPath_DummyPath_AddPathToApp(self):
        ...
        launcher = o3de_test_tools.launchers.MacLauncher(mock_workspace, ["some_args"])
    ...
    @mock.patch('o3de_test_tools.launchers.MacLauncher.binary_path', mock.MagicMock)
    @mock.patch('subprocess.Popen')
    def test_Launch_DummyArgs_ArgsPassedToPopen(self, mock_subprocess):
        dummy_args = ["some_args"]
        launcher = o3de_test_tools.launchers.MacLauncher(mock.MagicMock(), dummy_args)
    ...
    @mock.patch('o3de_test_tools.launchers.MacLauncher.is_alive')
    def test_Kill_MockAliveFalse_SilentSuccess(self, mock_alive):
        mock_alive.return_value = False
        mock_proc = mock.MagicMock()
        launcher = o3de_test_tools.launchers.MacLauncher(mock.MagicMock(), ["dummy"])
