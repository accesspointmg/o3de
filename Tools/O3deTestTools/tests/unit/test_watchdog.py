...
import o3de_test_tools.environment.watchdog as watchdog
...
class TestWatchdogMethods(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.environment.watchdog.logging.Logger.error')
    ...
    @mock.patch('threading.Thread.join', mock.MagicMock())
    @mock.patch('o3de_test_tools.environment.watchdog.Watchdog.is_alive')
    @mock.patch('o3de_test_tools.environment.watchdog.logging.Logger.error')
