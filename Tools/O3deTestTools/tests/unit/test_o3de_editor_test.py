...
import o3de_test_tools.o3de.editor_test as editor_test
...
class TestEditorTestSuite(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test.EditorTestSuite.filter_session_shared_tests')
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test.EditorTestSuite.filter_session_shared_tests')
    @mock.patch('o3de_test_tools.o3de.editor_test.EditorTestSuite.get_shared_tests')
