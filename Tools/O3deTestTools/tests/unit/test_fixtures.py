...
Unit tests for o3de_test_tools._internal.pytest_plugin.test_tools_fixtures
"""
...
import o3de_test_tools._internal.pytest_plugin.test_tools_fixtures as test_tools_fixtures
...
class TestFixtures(object):
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.test_tools_fixtures.logger')
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.test_tools_fixtures.datetime',
    ...
    @mock.patch("o3de_test_tools._internal.log.py_logging_util.initialize_logging", mock.MagicMock())
    @mock.patch("o3de_test_tools.builtin.helpers.setup_builtin_workspace")
    @mock.patch("o3de_test_tools.builtin.helpers.create_builtin_workspace")
    ...
    @mock.patch("o3de_test_tools.launchers.launcher_helper.create_game_launcher")
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.test_tools_fixtures.get_fixture_argument')
    @mock.patch('o3de_test_tools._internal.managers.o3de_process_killer.detect_lumberyard_processes')
    @mock.patch('o3de_test_tools._internal.managers.o3de_process_killer.kill_processes', mock.MagicMock())
    ...
    @mock.patch('o3de_test_tools.environment.watchdog.CrashLogWatchdog.start', mock.MagicMock())
    @mock.patch('o3de_test_tools.environment.watchdog.CrashLogWatchdog')
    ...
    @mock.patch('o3de_test_tools.environment.watchdog.CrashLogWatchdog.start')
    ...
    @mock.patch('o3de_test_tools.environment.watchdog.CrashLogWatchdog.start', mock.MagicMock())
    @mock.patch('o3de_test_tools.environment.watchdog.CrashLogWatchdog.stop')
