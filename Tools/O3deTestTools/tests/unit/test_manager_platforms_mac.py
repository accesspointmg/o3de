...
Unit tests for o3de_test_tools._internal.managers.platforms.mac
"""
...
from o3de_test_tools._internal.managers.platforms.mac import (
    _MacResourceLocator, MacWorkspaceManager,
    CACHE_DIR)
from o3de_test_tools import MAC
...
class TestMacResourceLocator(object):
    ...
    def test_PlatformCache_HasPath_ReturnsPath(self):
        mac_resource_locator = o3de_test_tools._internal.managers.platforms.mac._MacResourceLocator(mock_build_directory,
                                                                                                  mock_project)
