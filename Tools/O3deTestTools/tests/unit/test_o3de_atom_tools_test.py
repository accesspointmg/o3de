...
import o3de_test_tools.o3de.atom_tools_test as atom_tools_test
...
class TestAtomToolsTestSuite(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.o3de.atom_tools_test.AtomToolsTestSuite.filter_session_shared_tests')
    ...
    @mock.patch('o3de_test_tools.o3de.atom_tools_test.AtomToolsTestSuite.filter_session_shared_tests')
    @mock.patch('o3de_test_tools.o3de.atom_tools_test.AtomToolsTestSuite.get_shared_tests')
    ...
    @mock.patch(
        'o3de_test_tools.o3de.multi_test_framework.skip_pytest_runtest_setup', mock.MagicMock(side_effect=Exception))
