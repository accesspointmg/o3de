...
import o3de_test_tools._internal.managers.artifact_manager
...
class TestBaseLauncher:
    ...
    def test_Construct_TestDoubles_BaseLauncherCreated(self):
        ...
        under_test = o3de_test_tools.launchers.Launcher(mock_workspace, ["some_args"])
        assert isinstance(under_test, o3de_test_tools.launchers.Launcher)
        return under_test

    def test_Construct_StringArgs_TypeError(self):
        mock_workspace = mock.MagicMock()
        with pytest.raises(TypeError):
            o3de_test_tools.launchers.Launcher(mock_workspace, "bad_args")
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.launch')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.setup')
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.launch')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.setup')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.stop')
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.launch', mock.MagicMock)
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.setup', mock.MagicMock)
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.stop')
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._kill')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.ensure_stopped')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.teardown')
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.save_project_log_files', mock.MagicMock())
    ...
    @mock.patch('o3de_test_tools._internal.managers.artifact_manager.ArtifactManager.save_artifact')
    ...
    def test_SaveProjectLogFiles_LogFilesExist_SavesOnlyLogs(self, mock_listdir, under_test):
        ...
        mock_workspace = mock.MagicMock()
        mock_artifact_manager = o3de_test_tools._internal.managers.artifact_manager.ArtifactManager(mock.MagicMock())
        mock_workspace.artifact_manager = mock_artifact_manager
        mock_workspace.paths.project_log.return_value = mock_project_log_path

        mock_launcher = o3de_test_tools.launchers.Launcher(mock_workspace, mock_args)
...
class TestLauncherBuilder(object):
    ...
    def test_CreateLauncher_DummyWorkspace_DefaultLauncher(self):
        ...
        under_test = o3de_test_tools.launchers.launcher_helper.create_game_launcher(
            dummy_workspace, o3de_test_tools.HOST_OS_EDITOR)
        assert isinstance(under_test, o3de_test_tools.launchers.Launcher)

    def test_CreateDedicateLauncher_DummyWorkspace_DefaultLauncher(self):
        dummy_workspace = mock.MagicMock()
        under_test = o3de_test_tools.launchers.launcher_helper.create_server_launcher(
            dummy_workspace, o3de_test_tools.HOST_OS_DEDICATED_SERVER)
        assert isinstance(under_test, o3de_test_tools.launchers.Launcher)
    ...
    def test_CreateEditor_DummyWorkspace_DefaultLauncher(self):
        ...
        under_test = o3de_test_tools.launchers.launcher_helper.create_editor(
            dummy_workspace, o3de_test_tools.HOST_OS_EDITOR)
        assert isinstance(under_test, o3de_test_tools.launchers.Launcher)
    ...
    def test_CreateAtomTools_DummyWorkspace_DefaultLauncher(self):
        dummy_workspace = mock.MagicMock()
        dummy_workspace.paths.build_directory.return_value = 'dummy'
        dummy_app_file_name = 'dummy_app'
        under_test = o3de_test_tools.launchers.launcher_helper.create_atom_tools_launcher(
            dummy_workspace, dummy_app_file_name)
        assert isinstance(under_test, o3de_test_tools.launchers.Launcher)
        assert under_test.app_file_name == dummy_app_file_name
