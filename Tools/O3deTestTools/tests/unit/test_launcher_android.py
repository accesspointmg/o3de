...
import o3de_test_tools.launchers
import o3de_test_tools.launchers.platforms.android.launcher
import o3de_test_tools.launchers.exceptions
import o3de_test_tools.mobile.android
...
@mock.patch('o3de_test_tools.launchers.platforms.android.launcher.open', mock.mock_open())
class TestLauncherModule:

    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.json.loads')
    def test_GetPackageName_MockJsonHasKey_ReturnsValue(self, mock_json):
        ...
        under_test = o3de_test_tools.launchers.platforms.android.launcher.get_package_name(PACKAGE_NAME)
    ...
    def test_GetPackageName_MockJsonMissingKey_SetupError(self, mock_json):
        ...
        with pytest.raises(o3de_test_tools.launchers.exceptions.SetupError):
            o3de_test_tools.launchers.platforms.android.launcher.get_package_name(PACKAGE_NAME)

    @mock.patch('o3de_test_tools.environment.process_utils.check_output')
    def test_GetPid_EarlyVersionAndExplodes_NoPid(self, mock_output):
        mock_output.side_effect = ['23', Exception]

        under_test = o3de_test_tools.launchers.platforms.android.launcher.get_pid("dummy", ["dummy"])
    ...
    def test_GenerateLoadLevelCommand_HasArg_ReturnsLoadLevelCommand(self):
        ...
        under_test = o3de_test_tools.launchers.platforms.android.launcher.generate_android_loadlevel_command(args_list)
...
@mock.patch('o3de_test_tools.launchers.platforms.android.launcher.get_package_name',
            mock.MagicMock(return_value=PACKAGE_NAME))
@mock.patch('o3de_test_tools.environment.file_system.create_backup', mock.MagicMock)
@mock.patch('o3de_test_tools.environment.file_system.restore_backup', mock.MagicMock)
@mock.patch('o3de_test_tools.mobile.android.check_adb_connection_state', mock.MagicMock)
@mock.patch('o3de_test_tools.launchers.platforms.android.launcher.open', mock.mock_open())
class TestAndroidLauncher:

    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    def test_ReadDeviceConfigINI_ReturnDeviceID_DeviceIDSet(self, mock_config):
        ...
        launcher = o3de_test_tools.launchers.AndroidLauncher(mock_workspace, ["dummy"])
    ...
    def test_ReadDeviceConfigINI_ReturnsInvalidConfig_SetupError(self, mock_config):
        ...
        with pytest.raises(o3de_test_tools.launchers.exceptions.SetupError):
            o3de_test_tools.launchers.AndroidLauncher(mock_workspace, ["dummy"])

    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    @mock.patch('o3de_test_tools.mobile.android.forward_tcp')
    @mock.patch('o3de_test_tools.mobile.android.reverse_tcp')
    @mock.patch('o3de_test_tools.mobile.android.undo_tcp_port_changes')
    def test_EnableAndroidCaps_SetsAndroidCaps_CallsReverseTCPForwardTCP(self, mock_undo_tcp, mock_reverse_tcp,
        ...
        mock_config.return_value = VALID_ANDROID_CONFIG
        mock_workspace = MockedWorkspace()
        under_test = o3de_test_tools.launchers.AndroidLauncher(mock_workspace, ["dummy"])
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher.backup_settings')
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher.configure_settings')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher._enable_android_capabilities')
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher._is_valid_android_environment')
    @mock.patch('o3de_test_tools.environment.waiter.wait_for', mock.MagicMock(return_value=True))
    ...
    @mock.patch('o3de_test_tools.mobile.android.can_run_android')
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher.backup_settings', mock.MagicMock())
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher.configure_settings',
                mock.MagicMock())
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher._enable_android_capabilities',
    ...
    @mock.patch('o3de_test_tools.mobile.android.get_devices')
    @mock.patch('o3de_test_tools.mobile.android.can_run_android', mock.MagicMock(return_value=True))
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher.backup_settings', mock.MagicMock())
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher.configure_settings',
                mock.MagicMock())
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher.restore_settings')
    @mock.patch('o3de_test_tools.mobile.android.undo_tcp_port_changes', mock.MagicMock)
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.AndroidLauncher._enable_android_capabilities',
                mock.MagicMock)
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    @mock.patch('o3de_test_tools.environment.process_utils.check_output')
    @mock.patch('o3de_test_tools.mobile.android.push_files_to_device', mock.MagicMock)
    ...
    @mock.patch('o3de_test_tools.launchers.platforms.android.launcher.get_pid')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    ...
    @mock.patch('o3de_test_tools.environment.process_utils.check_call')
    @mock.patch('o3de_test_tools.launchers.platforms.base.Launcher._config_ini_to_dict')
    @mock.patch('o3de_test_tools.mobile.android.check_adb_connection_state',
                mock.MagicMock(return_value=o3de_test_tools.mobile.android.SINGLE_DEVICE))
