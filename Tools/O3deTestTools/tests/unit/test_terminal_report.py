...
Unit tests for o3de_test_tools._internal.pytest_plugin.terminal_report
"""
import os
import pytest
import unittest.mock as mock

import o3de_test_tools._internal.pytest_plugin.terminal_report as terminal_report
...
class TestTerminalReport(object):
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.failed_test_rerun_command.build_rerun_commands')
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.terminal_report._add_commands')
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.terminal_report._add_ownership')
    @mock.patch('o3de_test_tools._internal.pytest_plugin.terminal_report._add_commands')
    ...
    @mock.patch('o3de_test_tools._internal.pytest_plugin.terminal_report._add_commands', mock.MagicMock())
