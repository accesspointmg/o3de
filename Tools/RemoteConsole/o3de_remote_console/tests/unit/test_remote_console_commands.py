...
test_o3de_remote_console contains all the unit test for remote console tool.
"""
try:  # Py2
    import mock
...
import o3de_remote_console.remote_console_commands as remote_console


@pytest.mark.unit
class TestScreenShot():

    @mock.patch('o3de_remote_console.remote_console_commands.RemoteConsole')
    @mock.patch('o3de_remote_console.remote_console_commands.capture_screenshot_command')
...
class TestRemoteConsole():
    ...
    @mock.patch('o3de_remote_console.remote_console_commands.threading', mock.MagicMock())
    ...
    @mock.patch('socket.socket', mock.MagicMock())
    @mock.patch('o3de_remote_console.remote_console_commands.RemoteConsole._create_message')
