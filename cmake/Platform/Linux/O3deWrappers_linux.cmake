...
set(O3DE_STRIP_DEBUG_SYMBOLS FALSE CACHE BOOL "Flag to strip debug symbols from the (non-debug) output binaries")
set(O3DE_DEBUG_SYMBOLS_FILE_EXTENSION "dbg" CACHE STRING "Extension for generated debug symbol files")
...
function(o3de_handle_custom_output_directory target output_subdirectory)
    # This function is deprecated, use o3de_handle_custom_output_directory instead
...
#! o3de_apply_debug_strip_options: Apply debug stripping options to the target output for non-debug configurations.
#
#\arg:target Name of the target to perform a post-build stripping of any debug symbol)
function(o3de_apply_debug_strip_options target)
    ...
    add_custom_command(TARGET ${target} POST_BUILD
        COMMAND "${CMAKE_COMMAND}" -P "${O3DE_ENGINE_PATH}/cmake/Platform/Linux/ProcessDebugSymbols.cmake"
                ${GNU_STRIP_TOOL}
                ${GNU_OBJCOPY}
                "$<TARGET_FILE:${target}>"
                ${O3DE_DEBUG_SYMBOLS_FILE_EXTENSION}
                ${target_type}
                ${DETACH_DEBUG_OPTION}
...
function(o3de_apply_debug_strip_options target)
    # This function is deprecated, use o3de_apply_debug_strip_options instead
    message(WARNING "o3de_apply_debug_strip_options is deprecated, use o3de_apply_debug_strip_options instead")
    o3de_apply_debug_strip_options(${target})
endfunction()
