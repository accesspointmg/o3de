...
get_directory_property(O3DE_PARENT_SCOPE PARENT_DIRECTORY)
if(O3DE_PARENT_SCOPE)
    set(O3DE_PARENT_SCOPE ${O3DE_PARENT_SCOPE} PARENT_SCOPE)
endif()

#! o3de_set: convenient function to set and export variable to the parent scope in scenarios
...
#! ly_set: deprecated alias for o3de_set
#
macro(ly_set name)
    #add a deprecation warning using this macro
    message(WARNING "ly_set is deprecated, use o3de_set instead")
    o3de_set(${name} ${ARGN})
endmacro()
