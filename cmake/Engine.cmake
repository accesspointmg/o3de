...
macro(o3de_engine_init)
    ...
    get_property(engine_restricteds GLOBAL PROPERTY O3DE_PATH_${engine_json_path}_RESTRICTEDS)
    ...
    get_property(engine_child_restricted_paths GLOBAL PROPERTY O3DE_PATH_${engine_json_path}_CHILD_RESTRICTED_JSON_PATHS)
    ...
    get_property(engine_dependent_restricteds GLOBAL PROPERTY O3DE_PATH_${engine_json_path}_DEPENDENT_RESTRICTEDS)
    ...
    set(O3DE_ENGINE_RESTRICTEDS ${engine_restricteds})
    ...
    set(O3DE_ENGINE_CHILD_RESTRICTED_JSON_PATHS ${engine_child_restricted_paths})
    ...
    set(O3DE_ENGINE_DEPENDENT_RESTRICTEDS ${engine_dependent_restricteds})
...
macro(o3de_engine_setup)
    ...
    foreach(restricted_json_path IN LISTS O3DE_MANIFEST_ALL_RESTRICTED_PATHS)
        ...
        foreach(restricted_platform_name ${restricted_platform_names})
            o3de_add_pal_platform_name(${restricted_platform_name})
        endforeach()
    endforeach()
    ...
    foreach(o3de_package_name_and_version IN LISTS engine_dependent_repos)
        o3de_find_package("${o3de_package_name_and_version}")
    endforeach()
    foreach(o3de_package_name_and_version IN LISTS engine_dependent_restricteds)
        o3de_find_package("${o3de_package_name_and_version}")
    endforeach()
