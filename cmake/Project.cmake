...
macro(o3de_project_init)
    ...
    get_property(project_restricteds GLOBAL PROPERTY O3DE_PATH_${project_json_path}_RESTRICTEDS)
    ...
    get_property(project_child_restricted_paths GLOBAL PROPERTY O3DE_PATH_${project_json_path}_CHILD_RESTRICTED_JSON_PATHS)
    ...
    get_property(project_dependent_restricteds GLOBAL PROPERTY O3DE_PATH_${project_json_path}_DEPENDENT_RESTRICTEDS)
    ...
    get_property(O3DE_ENGINE_RESTRICTEDS GLOBAL PROPERTY O3DE_PATH_${project_engine_json_path}_RESTRICTEDS)
    set_property(GLOBAL PROPERTY O3DE_ENGINE_RESTRICTEDS ${O3DE_ENGINE_RESTRICTEDS})
    ...
    get_property(O3DE_ENGINE_CHILD_RESTRICTED_JSON_PATHS GLOBAL PROPERTY O3DE_PATH_${project_engine_json_path}_CHILD_RESTRICTED_JSON_PATHS)
    set_property(GLOBAL PROPERTY O3DE_ENGINE_CHILD_RESTRICTED_JSON_PATHS ${O3DE_ENGINE_CHILD_RESTRICTED_JSON_PATHS})
    ...
    get_property(O3DE_ENGINE_DEPENDENT_RESTRICTEDS GLOBAL PROPERTY O3DE_PATH_${project_engine_json_path}_DEPENDENT_RESTRICTEDS)
    set_property(GLOBAL PROPERTY O3DE_ENGINE_DEPENDENT_RESTRICTEDS ${O3DE_ENGINE_DEPENDENT_RESTRICTEDS})
...
macro(o3de_project_setup)
    ...
    foreach(platform ${O3DE_ENGINE_PLATFORMS})
        o3de_add_pal_platform_name(${platform})
    endforeach()
    # These are all the platforms listed in all restricted.json
    get_property(O3DE_MANIFEST_ALL_RESTRICTED_PATHS GLOBAL PROPERTY O3DE_MANIFEST_ALL_RESTRICTED_PATHS)
    foreach(restricted_json_path IN LISTS O3DE_MANIFEST_ALL_RESTRICTED_PATHS)
        get_property(restricted_platform_names GLOBAL PROPERTY O3DE_PATH_${restricted_json_path}_PLATFORMS)
        foreach(restricted_platform_name ${restricted_platform_names})
            o3de_add_platform_name(${restricted_platform_name})
        endforeach()
    endforeach()
