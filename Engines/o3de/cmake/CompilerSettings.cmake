...
set(_cmake_CompilerSettings_cmake ${CMAKE_CURRENT_LIST_DIR})
get_property(O3DE_SCRIPT_ONLY GLOBAL PROPERTY "O3DE_SCRIPT_ONLY")

if("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Linux")
    if(O3DE_SCRIPT_ONLY)
        include(${_cmake_CompilerSettings_cmake}/Platform/Linux/Toolchain_scriptonly_linux.cmake)
    else()
        include(${_cmake_CompilerSettings_cmake}/Platform/Linux/CompilerSettings_linux.cmake)
    endif()
elseif("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Windows")
    if(O3DE_SCRIPT_ONLY)
        include(${_cmake_CompilerSettings_cmake}/Platform/Windows/Toolchain_scriptonly_windows.cmake)
    endif()
elseif("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Darwin")
    if(O3DE_SCRIPT_ONLY)
        message(FATAL_ERROR "Script only (quick start) projects are not yet supported on Mac")
    endif()
endif()
