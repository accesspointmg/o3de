...
class TestWaitFor(unittest.TestCase):
    ...
    def test_WaitForFunctionCall_GivenExceptionTimeoutExceeded_RaiseException(self):
        ...
        with self.assertRaises(Exception):
            o3de_test_tools.environment.waiter.wait_for(input_func, .001, Exception, 0)
    ...
    def test_WaitForFunctionCall_TimeoutExceeded_RaiseAssertionError(self):
        ...
        with self.assertRaises(Exception):
            o3de_test_tools.environment.waiter.wait_for(input_func, .001, interval=0)
    ...
    def test_WaitForFunctionCall_TimeoutExceeded_EnoughTime(self):
        ...
        try:
            o3de_test_tools.environment.waiter.wait_for(input_func, 0.1, Exception, interval=0.01)
        except Exception:
            pass
