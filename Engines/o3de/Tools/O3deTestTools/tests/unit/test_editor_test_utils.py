...
import o3de_test_tools.o3de.editor_test_utils as editor_test_utils
...
class TestEditorTestUtils(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.environment.process_utils.kill_processes_named')
    def test_KillAllLyProcesses_IncludeAP_CallsCorrectly(self, mock_kill_processes_named):
        ...
        editor_test_utils.kill_all_o3de_processes(include_asset_processor=True)
    ...
    def test_KillAllLyProcesses_NotIncludeAP_CallsCorrectly(self, mock_kill_processes_named):
        ...
        editor_test_utils.kill_all_o3de_processes(include_asset_processor=False)
    ...
    @mock.patch('o3de_test_tools.o3de.editor_test_utils._check_log_errors_warnings')
    @mock.patch('os.walk')
