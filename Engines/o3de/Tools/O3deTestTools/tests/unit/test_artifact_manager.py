...
class TestSetTestName(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_artifact_manager = o3de_test_tools._internal.managers.artifact_manager.ArtifactManager(
            self.mock_root)

    @mock.patch('o3de_test_tools._internal.managers.artifact_manager.ArtifactManager.set_dest_path')
    ...
    @mock.patch('os.makedirs', mock.MagicMock())
    @mock.patch('os.path.exists', mock.MagicMock(return_value=False))
    @mock.patch('o3de_test_tools._internal.managers.artifact_manager.ArtifactManager._get_collision_handled_filename')
...
class TestSaveArtifact(unittest.TestCase):
    ...
    def setUp(self):
        self.mock_root = ROOT_LOG_FOLDER
        self.mock_artifact_manager = o3de_test_tools._internal.managers.artifact_manager.ArtifactManager(self.mock_root)

    @mock.patch('os.path.exists', mock.MagicMock(return_value=False))
    @mock.patch('shutil.copytree')
    @mock.patch('os.path.isdir')
    @mock.patch('o3de_test_tools.environment.file_system.reduce_file_name_length')
...
class TestGatherArtifacts(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.environment.file_system.sanitize_file_name')
    @mock.patch('shutil.make_archive')
