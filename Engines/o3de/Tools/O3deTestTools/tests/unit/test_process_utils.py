...
class TestCloseWindowsProcess(unittest.TestCase):
    ...
    @mock.patch('o3de_test_tools.WINDOWS', False)
...
class TestProcessMatching(unittest.TestCase):
    ...
    @mock.patch("o3de_test_tools.environment.process_utils._safe_get_processes")
    ...
    @mock.patch('o3de_test_tools.environment.process_utils._safe_kill_processes')
    @mock.patch('o3de_test_tools.environment.process_utils._safe_get_processes')
    ...
    @mock.patch('o3de_test_tools.environment.process_utils._safe_kill_processes', mock.MagicMock)
    @mock.patch('o3de_test_tools.environment.process_utils._safe_get_processes')
    ...
    @mock.patch('o3de_test_tools.environment.process_utils._safe_kill_process')
    @mock.patch('psutil.Process')
    ...
    @mock.patch('o3de_test_tools.environment.waiter.wait_for')
    @mock.patch('logging.Logger.warning')
