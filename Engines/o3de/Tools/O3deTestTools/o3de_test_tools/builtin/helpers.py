...
import o3de_test_tools._internal.pytest_plugin as pytest_plugin
import o3de_test_tools._internal.managers.workspace as internal_workspace
from o3de_test_tools import LINUX, MAC, WINDOWS
import os, stat
...
def create_builtin_workspace(
    ...
    if WINDOWS:
        from o3de_test_tools._internal.managers.platforms.windows import WindowsWorkspaceManager
        build_class = WindowsWorkspaceManager
    elif MAC:
        from o3de_test_tools._internal.managers.platforms.mac import MacWorkspaceManager
        build_class = MacWorkspaceManager
    elif LINUX:
        from o3de_test_tools._internal.managers.platforms.linux import LinuxWorkspaceManager
