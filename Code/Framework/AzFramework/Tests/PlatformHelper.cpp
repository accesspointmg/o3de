...
TEST_F(PlatformHelperTest, SpecialAllFlag_PlatformId_Valid)
{
    ...
    EXPECT_THAT(platforms, testing::UnorderedElementsAre("pc", "linux", "android", "ios", "mac", "server"));
}
...
TEST_F(PlatformHelperTest, SpecialAllClientFlag_PlatformId_Valid)
{
    ...
    EXPECT_THAT(platforms, testing::UnorderedElementsAre("pc", "linux", "android", "ios", "mac"));
}
