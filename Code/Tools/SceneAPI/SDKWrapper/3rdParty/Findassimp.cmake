...
block()
    ...
    o3de_fetch_content(assimp
        ...
        PATCH_COMMAND cmake -P "${O3DE_ENGINE_PATH}/cmake/PatchIfNotAlreadyPatched.cmake" ${ASSIMP_GIT_PATCH}
    ...
    include(Platform/Common/${O3DE_PAL_TRAIT_COMPILER_ID}/PAL_assimp_${O3DE_PAL_TRAIT_COMPILER_ID_LOWERCASE}.cmake)
    ...
    cmake_path(RELATIVE_PATH CMAKE_CURRENT_SOURCE_DIR BASE_DIRECTORY ${O3DE_ENGINE_PATH} OUTPUT_VARIABLE relative_target_source_dir)
    ...
    o3de_install(FILES ${CMAKE_CURRENT_LIST_DIR}/Installer/Findassimp.cmake DESTINATION cmake/3rdParty)
