...
set(o3de_game_resource_folder ${CMAKE_CURRENT_LIST_DIR}/Resources)
if (NOT EXISTS ${o3de_game_resource_folder})
    message(FATAL_ERROR "Missing expected resources folder")
endif()

target_sources(AzTestRunner PRIVATE ${o3de_game_resource_folder}/Images.xcassets)
...
xctest_add_bundle(TestLauncherTarget AzTestRunner
    ${o3de_game_resource_folder}/Info.plist
